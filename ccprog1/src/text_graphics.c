...
void printSeparator(void) {
  ...
  for (int nPrintedDashCount = 0; nPrintedDashCount < MAX_PRINT_WIDTH; nPrintedDashCount++) printf("━");
...
/**
 * Prints out a ship's sprite based on the provided cargo limit of the player's ship.
